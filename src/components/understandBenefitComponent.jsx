                        ...
                        <div className='relative flex flex-col justify-center items-center w-full h-full'>
                            <div className='flex flex-col w-full px-0 sm:px-5'>
                                ...
                                <div className='w-full flex gap-x-10 my-5 sm:my-10'>
                                    ...
                                    <button className='rounded-[8px] bg-[#1D6996] py-3 sm:py-3 px-8 text-[14px] sm:px-14 font-Jakarta font-semibold text-white hover:bg-[#1a5e87] duration-150 drop-shadow-2xl shadow-black/20 shadow-2xl'>Learn More</button>
                                </div>
                            </div>
                        </div>
                    </div>
