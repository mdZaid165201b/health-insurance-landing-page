...
//             detail:
//                 "Easily compare insurance plans side by side to see what's covered and what's not.",
//         },
//         {
//             icon: JargonFreeIcon,
//             title: "Jargon-Free Explanations",
//             detail:
//                 "We break down insurance terms and jargon so you can understand your coverage.",
//         },
//         {
//             icon: JargonFreeIcon,
//             title: "Interactive Tools",
//             detail:
//                 "Use sliders, filters, and interactive guides to explore your options.",
//         },
//         {
//             icon: JargonFreeIcon,
...
//             {/*</div>*/}
//             <div className='z-50 p-5 sm:p-0 h-full w-full'>
...
//                             </div>
//                         </div>
//                         <div className='w-full sm:w-[60%] h-full sm:flex flex-col sm:flex-row justify-center  md:p-5 lg:p-7 xl:p-0 items-center lg:pr-0 xl:pr-0 sm:pr-5   hidden '>
//
//                             <Swiper
//                                 spaceBetween={40}
//                                 slidesPerView={3}
...
//                                         <SwiperSlide className='w-[320px] h-full sm:w-[330px] sm:h-[350px]'>
...
function FeatureComponent() {
    ...
    return (
        <section className="w-full z-50 h-fit sm:h-[585px] mb-10 relative ">
            ...
            {/*</div>*/}
            <div
                className="z-50 xl:p-5 xl:pr-0 sm:p-5   h-full w-full"
                id="main_container"
            >
                <div className="w-full h-full flex sm:flex-row flex-col font-bold text-2xl">
                    <div className="w-full sm:w-[40%] h-full flex justify-center p-5 sm:p-10">
                        <div className="sm:w-[350px] flex flex-col gap-y-5 w-full justify-center">
                            <div className="text-4xl text-white  font-Jakarta font-extrabold">
                                <h1>Our Features Specially For You</h1>
                            </div>
                            <div className="text-[15px] sm:text-[17px] font-normal tracking-wide font-Jakarta text-white capitalize">
                                <h1>
                            ...
                            <div>
                                <button className=" w bg-[#1D6996] sm:bg-[#FDD619] hover:sm:bg-[#e3c016] hover:bg-[#1a5e87] text-white font-bold [word-spacing:3px] sm:text-black duration-150 w-[178px] h-[66px] text-[17px] font-Jakarta rounded-[8px] shadow-2xl shadow-black/40">
                                    Get Started
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="w-full sm:w-[60%] h-full sm:flex flex-col sm:flex-row justify-center  md:p-5 lg:p-7 xl:p-10 items-center lg:pr-0 xl:pr-0 sm:pr-5   hidden ">
                        ...
                        >
                            {featuresData.map((current, index) => (
                                <SwiperSlide
                                    id="customSwiperStyle"
                                    key={index}
                                    className="w-[320px] h-full sm:w-[330px] sm:h-[350px]"
                                >
                    ...
                    <div className="w-full sm:w-[60%] h-full flex flex-col gap-y-5 justify-between  items-center p-5 sm:hidden ">
                        {featuresData.map((current, index) => (
                            <div
                                key={index}
                                className="w-full h-full sm:w-[330px] sm:h-[350px] bg-white shadow-[6px_6px_0px_0px_rgba(71,181,255,1)] rounded-[2px] flex items-center px-8"
                            >
                                <div className="w-full h-full flex flex-col items-center  gap-y-4 py-10">
                                    <div className="w-[60px] h-[60px] bg-[#47B5FF82] rounded-full flex items-center p-2 relative">
                                        <img
