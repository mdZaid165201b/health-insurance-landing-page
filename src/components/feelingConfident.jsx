            ...
            {/* left side */}
                ...
                <div className='w-full sm:w-[50%] flex justify-center h-full pt-0 sm:pt-14'>
                    <div className='h-full flex justify-center w-[570px]'>
                        <img src={ConfidentRightImage} alt="Confident Right" className='h-full w-full hidden sm:flex' />
                        <img src={ConfidentRightSmallScreenBG} alt="Confident Right" className=' w-[361px] h-[382px] pb-10 px-5 flex sm:hidden' />
                    </div>
                </div>
            </div>
        </section>
