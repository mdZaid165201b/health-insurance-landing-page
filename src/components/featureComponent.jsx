                ...
                <div className='w-full h-full flex font-bold text-2xl'>
                        <div className='w-[40%] h-full flex justify-center p-10'>
                            <div className='w-[350px] flex flex-col gap-y-5 justify-center'>
                                ...
                                <div>
                                    <button className=' w bg-[#FDD619] hover:bg-[#e3c016] duration-150 w-[178px] h-[66px] text-[17px] font-semibold font-Jakarta rounded-[8px] shadow-2xl shadow-black/40'>Get Started</button>
                                </div>
                            </div>
                        </div>
                        <div className='w-[60%] h-full flex justify-between  items-center p-10'>
                            <Swiper
                                spaceBetween={-200}
                                slidesPerView={2}
